...
func (in *GroupQualityOfServiceLimitsParameters) DeepCopyInto(out *GroupQualityOfServiceLimitsParameters) {
	*out = *in
	...
	in.Warning.DeepCopyInto(&out.Warning)
...
func (in *QualityOfServiceLimits) DeepCopyInto(out *QualityOfServiceLimits) {
	*out = *in
	if in.StorageQuotaKiBs != nil {
		in, out := &in.StorageQuotaKiBs, &out.StorageQuotaKiBs
		*out = new(int64)
		**out = **in
	}
	...
	if in.InboundKiBsPerMin != nil {
		in, out := &in.InboundKiBsPerMin, &out.InboundKiBsPerMin
		*out = new(int64)
		**out = **in
	}
	if in.OutboundKiBsPerMin != nil {
		in, out := &in.OutboundKiBsPerMin, &out.OutboundKiBsPerMin
		*out = new(int64)
		**out = **in
	}
}
